...
const (
	...
	// Opaque HTTP endpoints; application protocols and authorization remain at the backend.
	ServiceType_SERVICE_TYPE_HTTP ServiceType = 4
)
...
const file_api_sam_proto_rawDesc = "" +
	...
	"\x1aENROLLMENT_STATUS_REJECTED\x10\x03*\x8a\x01\n" +
	...
	"\x10SERVICE_TYPE_A2A\x10\x03\x12\x15\n" +
	"\x11SERVICE_TYPE_HTTP\x10\x04B\x1bZ\x19github.com/google/sam/apib\x06proto3"
